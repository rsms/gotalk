...
type Handlers {
  ...
  interface ReqBufferHandler(Buf|String, BufferResult)
  interface ReqValueHandler(any, ValueResult)
  interface NotBufferHandler(Buf|String)
  interface NotValueHandler(any)
